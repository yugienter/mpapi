...
export class CreateFirstTable1690871999787 implements MigrationInterface {
  name = 'CreateFirstTable1690871999787';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IDX_3be9f7978916158ca4f0d90484 ON user`);
