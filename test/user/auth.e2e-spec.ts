...
describe('Auth user (e2e)', () => {
  ...
  it('Register no password for new company_user: /api/v1/auth/company/register (POST)', () => {
    const seed = {
      user: {
      ...
      company: {
        ...
        numberOfEmployees: 0,
        sellOfShares: 0,
        expectedPriceOfShares: 0,
        expectedPriceOfSharesPercent: 0,
        issuanceRaiseMoney: 0,
        issuancePriceOfShares: 0,
        issuancePriceOfSharesPercent: 0,
